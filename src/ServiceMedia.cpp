    ...
    _trt__GetServiceCapabilitiesResponse& trt__GetServiceCapabilitiesResponse)
{
    ...
    trt__GetServiceCapabilitiesResponse.Capabilities = ctx->getMediaServiceCapabilities(soap);

    return SOAP_OK;
}

int MediaBindingService::GetVideoSources(_trt__GetVideoSources* trt__GetVideoSources,
    _trt__GetVideoSourcesResponse& trt__GetVideoSourcesResponse)
{
    ...
    for (auto it = profiles.cbegin(); it != profiles.cend(); ++it) {
        trt__GetVideoSourcesResponse.VideoSources.push_back(it->second.get_video_src(soap));
    }

    return SOAP_OK;
}

int MediaBindingService::GetAudioSources(_trt__GetAudioSources* trt__GetAudioSources,
...
int MediaBindingService::GetAudioOutputs(_trt__GetAudioOutputs* trt__GetAudioOutputs,
...
int MediaBindingService::CreateProfile(_trt__CreateProfile* trt__CreateProfile,
...
int MediaBindingService::GetProfile(
    _trt__GetProfile* trt__GetProfile, _trt__GetProfileResponse& trt__GetProfileResponse)
{
    ...
    if (it != profiles.end()) {
        trt__GetProfileResponse.Profile = it->second.get_profile(soap);
        ret = SOAP_OK;
    }
...
int MediaBindingService::GetProfiles(
    _trt__GetProfiles* trt__GetProfiles, _trt__GetProfilesResponse& trt__GetProfilesResponse)
{
    DEBUG_MSG("Media: %s\n", __FUNCTION__);
    ...
    for (auto it = profiles.cbegin(); it != profiles.cend(); ++it) {
        trt__GetProfilesResponse.Profiles.push_back(it->second.get_profile(soap));
    }

    return SOAP_OK;
}

int MediaBindingService::AddVideoEncoderConfiguration(
...
int MediaBindingService::AddVideoSourceConfiguration(
...
int MediaBindingService::AddAudioEncoderConfiguration(
...
int MediaBindingService::AddAudioSourceConfiguration(
...
int MediaBindingService::AddPTZConfiguration(_trt__AddPTZConfiguration* trt__AddPTZConfiguration,
...
int MediaBindingService::AddVideoAnalyticsConfiguration(
...
int MediaBindingService::AddMetadataConfiguration(
...
int MediaBindingService::AddAudioOutputConfiguration(
...
int MediaBindingService::AddAudioDecoderConfiguration(
...
int MediaBindingService::RemoveVideoEncoderConfiguration(
...
int MediaBindingService::RemoveVideoSourceConfiguration(
...
int MediaBindingService::RemoveAudioEncoderConfiguration(
...
int MediaBindingService::RemoveAudioSourceConfiguration(
...
int MediaBindingService::RemovePTZConfiguration(
...
int MediaBindingService::RemoveVideoAnalyticsConfiguration(
...
int MediaBindingService::RemoveMetadataConfiguration(
...
int MediaBindingService::RemoveAudioOutputConfiguration(
...
int MediaBindingService::RemoveAudioDecoderConfiguration(
...
int MediaBindingService::DeleteProfile(_trt__DeleteProfile* trt__DeleteProfile,
    ...
    _trt__GetVideoSourceConfigurationsResponse& trt__GetVideoSourceConfigurationsResponse)
{
    ...
    for (auto it = profiles.cbegin(); it != profiles.cend(); ++it) {
        trt__GetVideoSourceConfigurationsResponse.Configurations.push_back(
            it->second.get_video_src_cnf(soap));
    }
    ...
    _trt__GetVideoEncoderConfigurationsResponse& trt__GetVideoEncoderConfigurationsResponse)
{
    ...
    for (auto it = profiles.cbegin(); it != profiles.cend(); ++it) {
        trt__GetVideoEncoderConfigurationsResponse.Configurations.push_back(
            it->second.get_video_enc_cfg(soap));
    }

    return SOAP_OK;
}

int MediaBindingService::GetAudioSourceConfigurations(
...
int MediaBindingService::GetAudioEncoderConfigurations(
...
int MediaBindingService::GetVideoAnalyticsConfigurations(
...
int MediaBindingService::GetMetadataConfigurations(
...
int MediaBindingService::GetAudioOutputConfigurations(
...
int MediaBindingService::GetAudioDecoderConfigurations(
...
int MediaBindingService::GetVideoEncoderConfiguration(
...
int MediaBindingService::GetAudioSourceConfiguration(
...
int MediaBindingService::GetAudioEncoderConfiguration(
...
int MediaBindingService::GetVideoAnalyticsConfiguration(
...
int MediaBindingService::GetMetadataConfiguration(
...
int MediaBindingService::GetAudioOutputConfiguration(
...
int MediaBindingService::GetAudioDecoderConfiguration(
...
int MediaBindingService::GetCompatibleVideoEncoderConfigurations(
...
int MediaBindingService::GetCompatibleVideoSourceConfigurations(
...
int MediaBindingService::GetCompatibleAudioEncoderConfigurations(
...
int MediaBindingService::GetCompatibleAudioSourceConfigurations(
...
int MediaBindingService::GetCompatibleVideoAnalyticsConfigurations(
...
int MediaBindingService::GetCompatibleMetadataConfigurations(
...
int MediaBindingService::GetCompatibleAudioOutputConfigurations(
...
int MediaBindingService::GetCompatibleAudioDecoderConfigurations(
...
int MediaBindingService::SetVideoSourceConfiguration(
...
int MediaBindingService::SetVideoEncoderConfiguration(
...
int MediaBindingService::SetAudioSourceConfiguration(
...
int MediaBindingService::SetAudioEncoderConfiguration(
...
int MediaBindingService::SetVideoAnalyticsConfiguration(
...
int MediaBindingService::SetMetadataConfiguration(
...
int MediaBindingService::SetAudioOutputConfiguration(
...
int MediaBindingService::SetAudioDecoderConfiguration(
...
int MediaBindingService::GetVideoSourceConfigurationOptions(
...
int MediaBindingService::GetVideoEncoderConfigurationOptions(
...
int MediaBindingService::GetAudioSourceConfigurationOptions(
...
int MediaBindingService::GetAudioEncoderConfigurationOptions(
...
int MediaBindingService::GetMetadataConfigurationOptions(
...
int MediaBindingService::GetAudioOutputConfigurationOptions(
...
int MediaBindingService::GetAudioDecoderConfigurationOptions(
...
int MediaBindingService::GetStreamUri(
    _trt__GetStreamUri* trt__GetStreamUri, _trt__GetStreamUriResponse& trt__GetStreamUriResponse)
{
    DEBUG_MSG(
        "Media: %s   for profile:%s\n", __FUNCTION__, trt__GetStreamUri->ProfileToken.c_str());
    ...
    if (it != profiles.end()) {
        ...
        trt__GetStreamUriResponse.MediaUri->Uri
            = ctx->get_stream_uri(it->second.get_url(), htonl(soap->ip));
        ret = SOAP_OK;
    }
...
int MediaBindingService::StartMulticastStreaming(
...
int MediaBindingService::StopMulticastStreaming(
...
int MediaBindingService::SetSynchronizationPoint(
...
int MediaBindingService::GetSnapshotUri(_trt__GetSnapshotUri* trt__GetSnapshotUri,
    _trt__GetSnapshotUriResponse& trt__GetSnapshotUriResponse)
{
    ...
    if (it != profiles.end()) {
        ...
        trt__GetSnapshotUriResponse.MediaUri->Uri
            = ctx->get_snapshot_uri(it->second.get_snapurl(), htonl(soap->ip));
        ret = SOAP_OK;
    }
...
int MediaBindingService::GetVideoSourceModes(_trt__GetVideoSourceModes* trt__GetVideoSourceModes,
...
int MediaBindingService::SetVideoSourceMode(_trt__SetVideoSourceMode* trt__SetVideoSourceMode,
...
int MediaBindingService::GetOSDs(
    _trt__GetOSDs* trt__GetOSDs, _trt__GetOSDsResponse& trt__GetOSDsResponse)
{
    DEBUG_MSG("Media: %s\n", __FUNCTION__);
    return SOAP_OK;
}

int MediaBindingService::GetOSD(
    _trt__GetOSD* trt__GetOSD, _trt__GetOSDResponse& trt__GetOSDResponse)
{
    DEBUG_MSG("Media: %s\n", __FUNCTION__);
    return SOAP_OK;
}

int MediaBindingService::GetOSDOptions(_trt__GetOSDOptions* trt__GetOSDOptions,
...
int MediaBindingService::SetOSD(
    _trt__SetOSD* trt__SetOSD, _trt__SetOSDResponse& trt__SetOSDResponse)
{
    DEBUG_MSG("Media: %s\n", __FUNCTION__);
    return SOAP_OK;
}

int MediaBindingService::CreateOSD(
    _trt__CreateOSD* trt__CreateOSD, _trt__CreateOSDResponse& trt__CreateOSDResponse)
{
    DEBUG_MSG("Media: %s\n", __FUNCTION__);
    return SOAP_OK;
}

int MediaBindingService::DeleteOSD(
    _trt__DeleteOSD* trt__DeleteOSD, _trt__DeleteOSDResponse& trt__DeleteOSDResponse)
{
    DEBUG_MSG("Media: %s\n", __FUNCTION__);
    return SOAP_OK;
}
