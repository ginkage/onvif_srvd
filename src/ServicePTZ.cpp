...
int PTZBindingService::GetServiceCapabilities(
...
int PTZBindingService::GetConfigurations(_tptz__GetConfigurations* tptz__GetConfigurations,
...
int PTZBindingService::GetPresets(
    _tptz__GetPresets* tptz__GetPresets, _tptz__GetPresetsResponse& tptz__GetPresetsResponse)
{
    int i;
...
int PTZBindingService::SetPreset(
    _tptz__SetPreset* tptz__SetPreset, _tptz__SetPresetResponse& tptz__SetPresetResponse)
{
    DEBUG_MSG("PTZ: %s\n", __FUNCTION__);
    return SOAP_OK;
}

int PTZBindingService::RemovePreset(_tptz__RemovePreset* tptz__RemovePreset,
...
int PTZBindingService::GotoPreset(
    _tptz__GotoPreset* tptz__GotoPreset, _tptz__GotoPresetResponse& tptz__GotoPresetResponse)
{
    char cmd[1024];
    ...
    if ((tptz__GotoPreset->PresetToken.back() >= '0')
        && (tptz__GotoPreset->PresetToken.back() <= '9')) {
        sprintf(cmd, "%s %c", ctx->get_ptz_node()->get_move_preset().c_str(),
            tptz__GotoPreset->PresetToken.back());
        system(cmd);
    }
...
int PTZBindingService::GetStatus(
    _tptz__GetStatus* tptz__GetStatus, _tptz__GetStatusResponse& tptz__GetStatusResponse)
{
    DEBUG_MSG("PTZ: %s\n", __FUNCTION__);
    return SOAP_OK;
}

int PTZBindingService::GetConfiguration(_tptz__GetConfiguration* tptz__GetConfiguration,
...
int GetPTZNode(struct soap* soap, tt__PTZNode* ptzn)
{
    ...
    *ptzn->Name = "PTZ";
    ...
    soap_default_std__vectorTemplateOfPointerTott__Space2DDescription(
        soap, &ptzn->SupportedPTZSpaces->tt__PTZSpaces::RelativePanTiltTranslationSpace);
    soap_default_std__vectorTemplateOfPointerTott__Space1DDescription(
        soap, &ptzn->SupportedPTZSpaces->tt__PTZSpaces::RelativeZoomTranslationSpace);
    soap_default_std__vectorTemplateOfPointerTott__Space2DDescription(
        soap, &ptzn->SupportedPTZSpaces->tt__PTZSpaces::ContinuousPanTiltVelocitySpace);
    soap_default_std__vectorTemplateOfPointerTott__Space1DDescription(
        soap, &ptzn->SupportedPTZSpaces->tt__PTZSpaces::ContinuousZoomVelocitySpace);
    soap_default_std__vectorTemplateOfPointerTott__Space1DDescription(
...
int PTZBindingService::GetNodes(
    _tptz__GetNodes* tptz__GetNodes, _tptz__GetNodesResponse& tptz__GetNodesResponse)
{
    DEBUG_MSG("PTZ: %s\n", __FUNCTION__);
...
int PTZBindingService::GetNode(
    _tptz__GetNode* tptz__GetNode, _tptz__GetNodeResponse& tptz__GetNodeResponse)
{
    DEBUG_MSG("PTZ: %s\n", __FUNCTION__);
...
int PTZBindingService::SetConfiguration(_tptz__SetConfiguration* tptz__SetConfiguration,
...
int PTZBindingService::GetConfigurationOptions(
...
int PTZBindingService::GotoHomePosition(_tptz__GotoHomePosition* tptz__GotoHomePosition,
...
int PTZBindingService::SetHomePosition(_tptz__SetHomePosition* tptz__SetHomePosition,
...
int PTZBindingService::ContinuousMove(_tptz__ContinuousMove* tptz__ContinuousMove,
...
int PTZBindingService::RelativeMove(_tptz__RelativeMove* tptz__RelativeMove,
...
int PTZBindingService::SendAuxiliaryCommand(_tptz__SendAuxiliaryCommand* tptz__SendAuxiliaryCommand,
...
int PTZBindingService::AbsoluteMove(_tptz__AbsoluteMove* tptz__AbsoluteMove,
...
int PTZBindingService::GetPresetTours(_tptz__GetPresetTours* tptz__GetPresetTours,
...
int PTZBindingService::GetPresetTour(_tptz__GetPresetTour* tptz__GetPresetTour,
...
int PTZBindingService::GetPresetTourOptions(_tptz__GetPresetTourOptions* tptz__GetPresetTourOptions,
...
int PTZBindingService::CreatePresetTour(_tptz__CreatePresetTour* tptz__CreatePresetTour,
...
int PTZBindingService::ModifyPresetTour(_tptz__ModifyPresetTour* tptz__ModifyPresetTour,
...
int PTZBindingService::OperatePresetTour(_tptz__OperatePresetTour* tptz__OperatePresetTour,
...
int PTZBindingService::RemovePresetTour(_tptz__RemovePresetTour* tptz__RemovePresetTour,
...
int PTZBindingService::GetCompatibleConfigurations(
